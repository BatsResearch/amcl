...
from amcl_helper import projectToSimplex, subGradientMethod, subGradientMethod2
...
class AMCLWeightedVote(LabelModel):
    ...
    def get_weak_labels(self, vote_matrix):
        ...
        num_unlab = np.shape(vote_matrix)[0]
...
def main():
    '''
    Dylan's test script for evaluating AMCL
    '''
    ...
    preds = labelmodel.predict(ul_votes)
